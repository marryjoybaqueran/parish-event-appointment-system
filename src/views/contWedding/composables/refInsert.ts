...
/**
 * Generate unique reference number para sa wedding bookings
...
export function generateReferenceNumber(): string {
  ...
  return `REF-${dateStr}-${timeStr}-${randomNum}`
}

/**
 * Update wedding booking with reference number
...
/**
 * Get reference number ng specific wedding booking
