...
/**
 * Generate unique reference number para sa baptism bookings
 * Format: BAP-YYYYMMDD-HHMMSS-XXX
...
export function generateReferenceNumber(): string {
  ...
  return `BAP-${dateStr}-${timeStr}-${randomNum}`
}

/**
 * Update baptism booking with reference number
...
/**
 * Get reference number ng specific baptism booking
