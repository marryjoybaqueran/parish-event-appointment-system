...
/**
 * Generate unique reference number para sa thanksgiving bookings
 * Format: THK-YYYYMMDD-HHMMSS-XXX
...
export function generateReferenceNumber(): string {
  ...
  return `THK-${dateStr}-${timeStr}-${randomNum}`
}

/**
 * Update thanksgiving booking with reference number
...
/**
 * Get reference number ng specific thanksgiving booking
