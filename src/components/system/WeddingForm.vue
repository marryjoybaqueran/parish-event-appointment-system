...
import WeddingFormWidget from '@/components/system/wedding/WeddingFormWidget.vue'
import { useWeddingForm } from '@/components/system/wedding/composables/weddingDataSubmit.js'

// Use wedding form composable
const {
  formData,
  formAction,
  nameRules,
