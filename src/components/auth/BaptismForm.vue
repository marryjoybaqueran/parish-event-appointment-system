...
<template>
  <v-form v-model="valid" ref="form">
    <v-container>
      <v-divider thickness="3" class="mt-7"> <h2 class="info mt-7">Name of Baptised</h2></v-divider>
      ...
      <!--3rd Row-->
      <v-divider thickness="3" class="mt-7"> <h2 class="info mt-7">Name of Mother</h2></v-divider>
      <v-row>
        <v-col cols="5">
          <v-text-field
            v-model="Mfirstname"
      ...
      <!--4th Row-->
      <v-divider thickness="3" class="mt-7"> <h2 class="info mt-7">Name of Father</h2></v-divider>
      <v-row>
        <v-col cols="5">
          <v-text-field
            v-model="Ffirstname"
      ...
      <!--5th Row-->
      <v-divider thickness="3" class="mt-7"> <h2 class="info mt-7">Sponsored</h2></v-divider>
      <v-row>
        <v-col cols="4">
          <v-text-field
            v-model="S1firstname"
