...
<v-card class="glass-card mb-4">
  ...
  <v-card-text>
    <div class="space-y-3">
      <div v-for="(activity, index) in recentActivities" :key="index" class="d-flex gap-3">
        ...
        <div class="flex-1">
          ...
          <div class="text-caption text-grey-darken-2">{{ new Date(activity.changed_at).toLocaleString() }}</div>
        </div>
      </div>
    </div>
  </v-card-text>
