...
>
  <template #day="{ date }">
    <div class="v-date-picker-month__day"
         :class="{
      ...
      <div v-if="hasMultipleEvents(date)" class="multiple-events-indicator">
        <v-icon small>mdi-dots-horizontal</v-icon>
      </div>
      <div v-else-if="hasEvent(date)" class="single-event-indicator">
