    ...
    <template #content>
      <v-container fluid>
        <div class="bg-wrapper">
          <div class="carousel">
            <div class="carousel" :style="{ transform: `translateX(-${currentIndex * 100}vw)` }">
              <img v-for="(image, index) in images" :key="index" :src="image" class="bg-image" />
            </div>
        ...
        <v-row>
          ...
          <v-col class="centered-select">
            <v-card elevation="10" class="pa-10 text-center" v-bind:width="mobile ? '110%' : '75%'">
              <v-card-text>
