      ...
      <v-navigation-drawer v-model="drawer" temporary location="right" width="280">
        <v-list density="comfortable">
          <v-list-item title="Dashboard" prepend-icon="mdi-view-dashboard">
            <RouterLink to="/admin-dashboard" class="router-link"></RouterLink>
          </v-list-item>

          <v-divider class="my-2" />

          <v-list-item title="Special Wedding Mass" prepend-icon="mdi-ring">
            <RouterLink to="/admin-booking-view" class="router-link">Special Wedding Mass</RouterLink>
          </v-list-item>

          <v-list-item title="Funeral Mass" prepend-icon="mdi-cross">
