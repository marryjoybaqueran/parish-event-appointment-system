...
<template>
  <v-responsive class="border rounded">
    <v-app :theme="theme">
      <v-app-bar
        class="px-6"
        :color="theme === 'light' ? 'light-blue-lighten-1' : 'light-blue-darken-3'"
        border
      >
        ...
        <div class="d-flex align-end nav">
          <h3 class="icon"><v-icon icon="md:home"></v-icon> HOME</h3>
          <h3 class="icon"> <div><v-icon icon="md:event"></v-icon>BOOK EVENT</h3> </div>
        </div>
